...
double b = 1.2; // No of people falling ill
double v = 0.25; // No of people recovering
double ft = 0.3; // Fraction of infected people tested
int population = 10000; // Total population
float total = 0.0;
